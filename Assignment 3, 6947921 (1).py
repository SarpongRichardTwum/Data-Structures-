#https://github.com/SarpongRichardTwum/SarpongRichard/blob/main/README.md   ,link to github account

import numpy as np
w=10 #intensity in KN/m
L=12 #length measured in metres
#Question a
...
print(M)
print(V)
#The bending moment(M) at x=0 is -120.0 and the shear force=60
#Bending moment(M) and shear force at x=L
x=L
M=(w*(-6*x**2+6*L*x-L**2))/12
V=w*(L/2-x)
print(M)
